...
<div class="container text-justify my-5 h-100">
    <div class="row">
        <div class="col-md-6 mx-auto card card-body bg-light">
            <h2 class="display-4 mb-3 text-center text-primary">Create An Account</h2>
            <p class="text-center">Please fill the form to register with us</p>
            <form action="<?php echo URLROOT.'/users/register'; ?>" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <a href="<?php echo URLROOT.'/users/login';?>" class="btn btn-secondary btn-block">Have an
                            account? Login</a>
                    </div>
                </div>
            </form>
